...
SentryGuardian 项目文档索引。

## 快速上手

| 文档 | 说明 |
|------|------|
| [getting-started.md](./getting-started.md) | **30 分钟入门**：本地跑通 SDK → ingest → 控制台 |
| [configuration.md](./configuration.md) | **配置参考**：环境变量、DSN、SDK 选项、REST API |
| [../README.md](../README.md) | 仓库首页与命令速查 |

## 学习路径

| 文档 | 说明 |
|------|------|
| [learn/README.md](./learn/README.md) | 按角色推荐阅读顺序 |
